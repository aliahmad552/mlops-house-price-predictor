...
sale_model = load_model_from_run(sale_run_id, "xgb_sale_model")
rent_model = load_model_from_run(rent_run_id, "xgb_rent_model")

print("[INFO] Both Sale & Rent models loaded successfully!")
